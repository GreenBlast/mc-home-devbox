# Round 1 — full review of stepscode/atly-tileserver#350

First round on this PR. Do a **complete** pass; later rounds are deltas and
they inherit whatever you get wrong here.

- PR: https://github.com/stepscode/atly-tileserver/pull/350 — author `atlyguy123`, mode `review_only`
- Head SHA: `c28969b3ae2ad9974855a55008924c3c8df7b427` — base branch `develop`
- Collected facts: `/home/aviad/mc/traces/pr-tiles-350/collect/c28969b3ae2a/collect.json`
- Diff and collector output: `/home/aviad/mc/traces/pr-tiles-350/collect/c28969b3ae2a`
- Local clone for surrounding context (read-only, do not fetch or checkout):
  `/home/aviad/Projects/monorepo/atly-tileserver`

## What to do

1. **Read `/home/aviad/mc/traces/pr-tiles-350/collect/c28969b3ae2a/collect.json`.** It carries `meta`, `review_threads`,
...
**Last action. Write `/home/aviad/mc/traces/pr-tiles-350/iter-1.json`, then stop.**

```json
{
  "iteration": 1,
  "head_sha": "c28969b3ae2ad9974855a55008924c3c8df7b427",
  "verdict": "FINDINGS",
...
- `head_sha` must be `c28969b3ae2ad9974855a55008924c3c8df7b427`. If the PR has moved under you, say so via
