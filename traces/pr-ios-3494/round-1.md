# Round 1 — full review of stepscode/steps-ios#3494

First round on this PR. Do a **complete** pass; later rounds are deltas and
they inherit whatever you get wrong here.

- PR: https://github.com/stepscode/steps-ios/pull/3494 — author `8Gaston8`, mode `full_loop`
- Head SHA: `e8af28c3d2e3c3214bf69b44d2decb1c2e4e0171` — base branch `develop`
- Collected facts: `/home/aviad/mc/traces/pr-ios-3494/collect/e8af28c3d2e3/collect.json`
- Diff and collector output: `/home/aviad/mc/traces/pr-ios-3494/collect/e8af28c3d2e3`
- Local clone for surrounding context (read-only, do not fetch or checkout):
  `/home/aviad/Projects/monorepo/steps-ios`

## What to do

1. **Read `/home/aviad/mc/traces/pr-ios-3494/collect/e8af28c3d2e3/collect.json`.** It carries `meta`, `review_threads`,
...
**Last action. Write `/home/aviad/mc/traces/pr-ios-3494/iter-1.json`, then stop.**

```json
{
  "iteration": 1,
  "head_sha": "e8af28c3d2e3c3214bf69b44d2decb1c2e4e0171",
  "verdict": "FINDINGS",
...
- `head_sha` must be `e8af28c3d2e3c3214bf69b44d2decb1c2e4e0171`. If the PR has moved under you, say so via
